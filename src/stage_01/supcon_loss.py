"""
AWARE-NET Stage 1: Supervised Contrastive Loss Implementation

This module implements the SupCon loss function for authenticity modeling,
following the paradigm shift from "fake detection" to "authenticity modeling".
