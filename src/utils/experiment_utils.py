...
class ExperimentManager:
    ...
    def _save_registry(self):
        ...
        # Custom JSON serializer to handle enums and other non-serializable objects
        ...
        with open(self.registry_path, 'w') as f:
            json.dump(self.registry, f, indent=2, default=json_serializer)
    ...
    def generate_experiment_id(self, config: ExperimentConfig) -> str:
        ...
        config_str = json.dumps(asdict(config), sort_keys=True, default=json_serializer)
    ...
    def create_experiment(self, config: ExperimentConfig) -> str:
        ...
        with open(config_path, 'w') as f:
            json.dump(asdict(config), f, indent=2, default=json_serializer)
