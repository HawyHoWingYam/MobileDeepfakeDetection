"""
AWARE-NET: Advanced SupCon Training Script (Optional Research Feature)

This script implements advanced supervised contrastive learning for deepfake detection.
This is an EXPERIMENTAL/RESEARCH feature that goes beyond Stage 01 baseline requirements.

⚠️  ADVANCED FEATURE - NOT REQUIRED FOR STAGE 01:
This script is for research and experimentation purposes. For basic Stage 01 requirements,
use the simpler train_mobile_simple.py script instead.

Advanced Features:
- Supervised Contrastive Learning (SupCon) implementation
- Dual training modes: SupCon vs BCE comparison
- Academic-grade evaluation with statistical significance testing
- Complex calibration and cascade strategy validation
- Research-oriented multi-metric analysis

📊 COMPARISON PURPOSE:
- Compare simple BCE classification vs advanced SupCon learning
- Research authenticity modeling paradigm vs fake detection
- Academic paper experimentation and ablation studies
...
For Stage 01 baseline, use train_mobile_simple.py instead!
"""
