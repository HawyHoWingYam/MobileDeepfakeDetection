...
Feature\hyp space visualization (e.g., t\,\-SNE) and distributional distances (e.g., MMD) can quantify gaps between training sources and OOD sets \cite{todo_domain_adapt_survey}. Lightweight adaptation (temperature, thresholds) and progressive mixing schedules are promising deployment\hyp friendly options.
