...
\begin{table}[h]
  \centering
  \caption{Qualitative characteristics (to motivate protocol design).}
  ...
  \begin{tabular}{lllll}
    ...
    FaceForensics++ & Multiple & Mid & Actors & Diverse manipulations \\
    DFDC & Multiple & Mid\,–\,Low & Internet & Large\,–\,scale, mixed quality \\
    DeeperForensics & Multiple & Mid & Lab & Hard cases; challenging textures \\
    Deepfake\hyp Eval\hyp 2024 & Multiple & Mid\,–\,Low & Web & In\hyp the\hyp wild, multi\hyp source \\
    \bottomrule
  \end{tabular}
\end{table}
These traits justify balanced sampling across sources and holding out an OOD\,set.
