...
\begin{table}[h]
  \centering
  \caption{Single-model performance on combined validation (auto-generated).}\label{tab:single_models_auto}
...
\begin{table}[h]
  \centering
  \caption{Best cascade configurations (auto-generated).}\label{tab:cascade_best_auto}
